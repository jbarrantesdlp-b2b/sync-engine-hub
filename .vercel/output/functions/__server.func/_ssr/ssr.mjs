...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dotr6TcE.mjs");
...
var manifest = {
	"00d90b5753780f2377a77035c7a246b593bdc9cf96afdfbc2b4fb7a03339e8de": {
		functionName: "listWidgets_createServerFn_handler",
		importer: () => import("./api-c7kH_vbP.mjs")
	},
	"6c8b0048744340c04685b829b0e0f76c97f0bcd864d0a3f9a07edaf9ec5aef87": {
		functionName: "saveWidget_createServerFn_handler",
		importer: () => import("./api-c7kH_vbP.mjs")
	},
	"ac827e45ae1cab7c475f9815a9713caf0980c93793f8044cbe8a31e15c340e2d": {
		functionName: "getWidget_createServerFn_handler",
		importer: () => import("./api-c7kH_vbP.mjs")
	},
	"fbeec3c66d3bd29ee886153a2c4e9396dfc9959eef02b62b8be44c0e213cb464": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DGhjyWQP.mjs").then((n) => n.t),
